...
export const TRANSLATIONS = {
  en: {
    ...
    routeFallbackTitle: "Showing approximate path",
    routeFallbackMessage: "Live walking directions failed, so this is a straight-line guide (~{{distance}} km, about {{minutes}} min).",
  ...
  kn: {
    ...
    routeFallbackTitle: "ಅಂದಾಜು ಮಾರ್ಗ ತೋರಿಸಲಾಗುತ್ತಿದೆ",
    routeFallbackMessage: "ನೈಜ ನಡೆದಾಟ ಮಾರ್ಗ ಲಭ್ಯವಾಗಲಿಲ್ಲ, ಆದ್ದರಿಂದ ಇದು ಸುಮಾರು {{distance}} ಕಿ.ಮೀ (ಸಹಜವಾಗಿ {{minutes}} ನಿಮಿಷ) ಇರುವ ನೇರ ಮಾರ್ಗದ ಸೂಚನೆ.",
  ...
  hi: {
    ...
    routeFallbackTitle: "अनुमानित मार्ग दिख रहा है",
    routeFallbackMessage: "लाइव पैदल मार्ग नहीं मिला, इसलिए यह लगभग {{distance}} किमी (करीब {{minutes}} मिनट) का सीधा मार्ग दिखा रहा है।",
