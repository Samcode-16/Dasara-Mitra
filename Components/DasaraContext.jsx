...
export const TRANSLATIONS = {
  en: {
    ...
    footerDisclaimer: "Enjoy Dasara with smooth navigation and trusted updates.",
    ...
    // Find My Way - Emergency Tracker
    findMyWay: "Find My Way",
    findMyWayTitle: "Find My Way",
    findMyWaySubtitle: "Lost in the festival crowd? Set a safe meeting point and get guided back with one tap.",
    findMyWayYourLocation: "Your Location",
    findMyWayRefresh: "Refresh",
    findMyWayLocationFound: "Location detected",
    findMyWayFetchingLocation: "Getting your location...",
    findMyWayLocationError: "Unable to get location. Enable GPS and try again.",
    findMyWaySetHomeTab: "Set Home Base",
    findMyWayNavigateTab: "Navigate",
    findMyWaySetHomeBase: "Set Your Home Base",
    findMyWaySetHomeDesc: "Choose a safe meeting point like your hotel, parked vehicle, or a police outpost.",
    findMyWayUseCurrentLocation: "Use My Current Location",
    findMyWayCurrentLocation: "My Current Location",
    findMyWayPresetLocations: "Choose Preset Location",
    findMyWayCustomLocation: "Or enter custom coordinates:",
    findMyWayCustomName: "Location name (e.g., My Hotel)",
    findMyWayLatitude: "Latitude",
    findMyWayLongitude: "Longitude",
    findMyWaySaveCustom: "Save Custom Location",
    findMyWayHomeBaseLabel: "Home Base",
    findMyWayClearHome: "Clear home base",
    findMyWayTakeMeBack: "Take Me Back",
    findMyWayCalculating: "Calculating route...",
    findMyWayEnableLocation: "Enable location to get directions",
    findMyWayRouteReady: "Walking Route Ready",
    findMyWayFollowRoute: "Follow the green line on the map. Stay safe and stick to well-lit paths.",
    findMyWayRouteError: "Unable to calculate route. Please try again.",
    findMyWayNoHomeSet: "No home base set yet",
    findMyWaySetHomeNow: "Set Home Base Now",
    findMyWaySafetyTips: "Safety Tips",
  ...
  kn: {
    ...
    footerDisclaimer: "ಸುಗಮ ದಾಡಿ ಸೂಚನೆಗಳೊಂದಿಗೆ ದಸರಾವನ್ನು ಆನಂದಿಸಿ.",
    ...
    // Find My Way - Emergency Tracker (Kannada)
    findMyWay: "ನನ್ನ ದಾರಿ",
    findMyWayTitle: "ನನ್ನ ದಾರಿ ಹುಡುಕಿ",
    findMyWaySubtitle: "ಹಬ್ಬದ ಜನಜಂಗುಳಿಯಲ್ಲಿ ದಾರಿ ತಪ್ಪಿದ್ದೀರಾ? ಸುರಕ್ಷಿತ ಸ್ಥಳ ಗುರುತಿಸಿ, ಒಂದೇ ಒತ್ತುವಿಕೆಯಲ್ಲಿ ಮರಳಿ ಬನ್ನಿ.",
    findMyWayYourLocation: "ನಿಮ್ಮ ಸ್ಥಳ",
    findMyWayRefresh: "ಮರುಲೋಡ್",
    findMyWayLocationFound: "ಸ್ಥಳ ಪತ್ತೆಯಾಗಿದೆ",
    findMyWayFetchingLocation: "ನಿಮ್ಮ ಸ್ಥಳವನ್ನು ಪಡೆಯಲಾಗುತ್ತಿದೆ...",
    findMyWayLocationError: "ಸ್ಥಳ ಪಡೆಯಲಾಗಲಿಲ್ಲ. GPS ಸಕ್ರಿಯಗೊಳಿಸಿ ಮತ್ತು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.",
    findMyWaySetHomeTab: "ಮನೆ ಸ್ಥಳ ನಿಗದಿಪಡಿಸಿ",
    findMyWayNavigateTab: "ದಾರಿ ನೋಡಿ",
    findMyWaySetHomeBase: "ನಿಮ್ಮ ಮೂಲ ಸ್ಥಳ ನಿಗದಿಪಡಿಸಿ",
    findMyWaySetHomeDesc: "ನಿಮ್ಮ ಹೋಟೆಲ್, ಕಾರು ನಿಲ್ಲಿಸಿದ ಸ್ಥಳ ಅಥವಾ ಪೊಲೀಸ್ ಬೂತ್ ನಂತಹ ಸುರಕ್ಷಿತ ಸ್ಥಳ ಆಯ್ಕೆಮಾಡಿ.",
    findMyWayUseCurrentLocation: "ಪ್ರಸ್ತುತ ಸ್ಥಳ ಬಳಸಿ",
    findMyWayCurrentLocation: "ನನ್ನ ಪ್ರಸ್ತುತ ಸ್ಥಳ",
    findMyWayPresetLocations: "ಪೂರ್ವನಿಗದಿತ ಸ್ಥಳ ಆಯ್ಕೆಮಾಡಿ",
    findMyWayCustomLocation: "ಅಥವಾ ಕಸ್ಟಮ್ ನಿರ್ದೇಶಾಂಕಗಳನ್ನು ನಮೂದಿಸಿ:",
    findMyWayCustomName: "ಸ್ಥಳದ ಹೆಸರು (ಉದಾ: ನನ್ನ ಹೋಟೆಲ್)",
    findMyWayLatitude: "ಅಕ್ಷಾಂಶ",
    findMyWayLongitude: "ರೇಖಾಂಶ",
    findMyWaySaveCustom: "ಕಸ್ಟಮ್ ಸ್ಥಳ ಉಳಿಸಿ",
    findMyWayHomeBaseLabel: "ಮೂಲ ಸ್ಥಳ",
    findMyWayClearHome: "ಮೂಲ ಸ್ಥಳ ತೆಗೆದುಹಾಕಿ",
    findMyWayTakeMeBack: "ನನ್ನನ್ನು ಹಿಂದಕ್ಕೆ ಕರೆದುಕೊಂಡು ಹೋಗಿ",
    findMyWayCalculating: "ಮಾರ್ಗ ಲೆಕ್ಕಹಾಕಲಾಗುತ್ತಿದೆ...",
    findMyWayEnableLocation: "ದಿಕ್ಕುಗಳನ್ನು ಪಡೆಯಲು ಸ್ಥಳವನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿ",
    findMyWayRouteReady: "ನಡಿಗೆ ಮಾರ್ಗ ಸಿದ್ಧವಾಗಿದೆ",
    findMyWayFollowRoute: "ನಕ್ಷೆಯಲ್ಲಿ ಹಸಿರು ರೇಖೆಯನ್ನು ಅನುಸರಿಸಿ. ಬೆಳಕಿರುವ ಮಾರ್ಗಗಳಲ್ಲಿ ಸುರಕ್ಷಿತವಾಗಿ ಇರಿ.",
    findMyWayRouteError: "ಮಾರ್ಗ ಲೆಕ್ಕಹಾಕಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.",
    findMyWayNoHomeSet: "ಇನ್ನೂ ಮೂಲ ಸ್ಥಳ ನಿಗದಿಪಡಿಸಿಲ್ಲ",
    findMyWaySetHomeNow: "ಈಗ ಮೂಲ ಸ್ಥಳ ನಿಗದಿಪಡಿಸಿ",
    findMyWaySafetyTips: "ಸುರಕ್ಷತಾ ಸಲಹೆಗಳು",
  ...
  hi: {
    ...
    footerDisclaimer: "सुगम नेविगेशन और भरोसेमंद अपडेट के साथ दशहरे का आनंद लें।",
    ...
    // Find My Way - Emergency Tracker (Hindi)
    findMyWay: "मेरा रास्ता",
    findMyWayTitle: "मेरा रास्ता खोजें",
    findMyWaySubtitle: "उत्सव की भीड़ में खो गए? सुरक्षित मिलन स्थान चुनें और एक टैप में वापस पहुँचें।",
    findMyWayYourLocation: "आपका स्थान",
    findMyWayRefresh: "रिफ्रेश",
    findMyWayLocationFound: "स्थान पता लगा",
    findMyWayFetchingLocation: "आपका स्थान खोजा जा रहा है...",
    findMyWayLocationError: "स्थान नहीं मिला। GPS चालू करें और पुनः प्रयास करें।",
    findMyWaySetHomeTab: "होम बेस सेट करें",
    findMyWayNavigateTab: "नेविगेट करें",
    findMyWaySetHomeBase: "अपना होम बेस सेट करें",
    findMyWaySetHomeDesc: "अपने होटल, पार्क किए वाहन या पुलिस बूथ जैसा सुरक्षित स्थान चुनें।",
    findMyWayUseCurrentLocation: "मेरा वर्तमान स्थान उपयोग करें",
    findMyWayCurrentLocation: "मेरा वर्तमान स्थान",
    findMyWayPresetLocations: "पूर्व-निर्धारित स्थान चुनें",
    findMyWayCustomLocation: "या कस्टम निर्देशांक दर्ज करें:",
    findMyWayCustomName: "स्थान का नाम (जैसे: मेरा होटल)",
    findMyWayLatitude: "अक्षांश",
    findMyWayLongitude: "देशांतर",
    findMyWaySaveCustom: "कस्टम स्थान सहेजें",
    findMyWayHomeBaseLabel: "होम बेस",
    findMyWayClearHome: "होम बेस हटाएँ",
    findMyWayTakeMeBack: "मुझे वापस ले चलो",
    findMyWayCalculating: "रास्ता खोजा जा रहा है...",
    findMyWayEnableLocation: "दिशा-निर्देश के लिए स्थान सक्षम करें",
    findMyWayRouteReady: "पैदल मार्ग तैयार",
    findMyWayFollowRoute: "मानचित्र पर हरी रेखा का अनुसरण करें। रोशनी वाले रास्तों पर सुरक्षित रहें।",
    findMyWayRouteError: "रास्ता नहीं खोज सके। कृपया पुनः प्रयास करें।",
    findMyWayNoHomeSet: "अभी तक कोई होम बेस सेट नहीं है",
    findMyWaySetHomeNow: "अभी होम बेस सेट करें",
    findMyWaySafetyTips: "सुरक्षा सुझाव",
